...
import bannerHero from "assets/images/about-hero.png";

const AboutPage: FC = () => {
  return (
    <div>
      <ContextBanner title={bannerHero} backgroundImg={banner} />
      <S.Container>
        ...
        <S.Heading3>
          We are also take handle for Client's Budgeting. The exact budget will
          be finalized, after discussing the moodboards, designing the event,
          and choosing the detailed alternatives
        </S.Heading3>
      </S.Container>
      <S.ContainerPict>
        <img
